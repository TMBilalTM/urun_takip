...
$pageTitle = 'Ürün Giriş - ' . SITE_NAME;
$activePage = 'stock_in';
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($urunId <= 0 || $miktar <= 0) {
        ...
        // Stok güncelleme
        if($product->updateStock($urunId, $miktar, 'giris')) {
            // Stok hareketi ekle
            $stockData = [
                'urun_id' => $urunId,
            ...
            if($product->addStockMovement($stockData)) {
                $success = 'Stok girişi başarıyla gerçekleştirildi.';
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">Ürün Giriş İşlemi</h1>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-arrow-circle-down me-1"></i> Ürün Giriş Formu
                    </h5>
                </div>
                <div class="card-body">
                    <form action="stock_in.php<?= $selectedProduct ? '?id='.$selectedProduct['id'] : '' ?>" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="miktar" class="form-label">Giriş Miktarı</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="aciklama" name="aciklama" rows="3" placeholder="Opsiyonel açıklama girebilirsiniz"></textarea>
                        </div>
                        
                        <div class="d-grid gap-2 mt-4">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save me-1"></i> Stok Girişi Yap
                            </button>
                            <?php if($selectedProduct): ?>
